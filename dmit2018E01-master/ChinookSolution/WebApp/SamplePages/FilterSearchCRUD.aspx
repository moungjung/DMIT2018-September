...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="col-md-offset-1">
        ...
        <asp:RangeValidator ID="RangeEditReleaseYear" runat="server" ErrorMessage="Year needs to be between 1950 and today" Display="None"
            ForeColor="Firebrick" SetFocusOnError="true" ControlToValidate="EditReleaseYear" Type="Integer" MinimumValue="1950"></asp:RangeValidator>
        ...
        <br />
        <asp:GridView ID="AlbumList" runat="server" AutoGenerateColumns="false" AllowPaging="True" PageSize="5" 
            CssClass="table table-striped" GridLines="Horizontal" BorderStyle="None" DataSourceID="AlbumListODS" OnSelectedIndexChanged="AlbumList_SelectedIndexChanged">
            <Columns>
        ...
        &nbsp;&nbsp;
       <asp:DropDownList ID="EditAlbumArtistList" runat="server" DataSourceID="ArtistODS" DataTextField="Name" DataValueField="ArtistId"></asp:DropDownList>
        <br />
    ...
    <asp:ObjectDataSource ID="AlbumListODS" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="Album_FindByArtist" TypeName="ChinookSystem.BLL.AlbumController" 
        ...
        <SelectParameters>
            <asp:ControlParameter ControlID="ArtistList" DefaultValue="0" Name="artistid" PropertyName="SelectedValue" Type="Int32" />
        </SelectParameters>  
